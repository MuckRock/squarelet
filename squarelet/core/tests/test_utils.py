...
def test_pluralize():
    ...
    assert pluralize(0, "baby") == "babies"
    assert pluralize(2, "duck") == "ducks"
    assert pluralize(5, "sheep") == "sheep"
    assert pluralize(0, "category") == "categories"
    assert pluralize(2, "octopus") == "octopi"

    # Pluralize returns singular form for count of 1
    assert pluralize(1, "baby") == "baby"
    assert pluralize(1, "duck") == "duck"
