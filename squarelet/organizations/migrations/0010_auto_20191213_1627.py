...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The entitlement's name",
                        max_length=255,
                        verbose_name="name",
                    ),
                ),
                (
                    ...
                    autoslug.fields.AutoSlugField(
                        ...
                        populate_from=squarelet.organizations.models.entitlement_slug,
                        unique=True,
                        verbose_name="slug",
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        help_text="A brief description of the service this grants access to",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="The subscription ID on stripe",
                        max_length=255,
                        null=True,
                        unique=True,
                ...
                (
                    "update_on",
                    models.DateField(
                        help_text="Date when monthly resources are restored",
        ...
        migrations.RemoveField(model_name="plan", name="feature_level"),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="The pending plan to be updated to on the next billing cycle - used when downgrading a plan to let the organization finish out a subscription is paid for",
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                related_name="pending_organizations",
                to="organizations.Plan",
                verbose_name="next plan",
            ),
        ),
        migrations.AlterField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text="Entitlements granted by this plan",
                related_name="plans",
        ...
        migrations.AlterUniqueTogether(
            name="subscription", unique_together={("organization", "plan")}
        ),
        migrations.AlterUniqueTogether(
            name="entitlement", unique_together={("name", "client")}
        ),
    ]
