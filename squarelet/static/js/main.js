...
var AutocompleteView = /** @class */ (function () {
    ...
    AutocompleteView.prototype.fetch = function (term, append) {
        ...
        this.async = fetchUrl("autocomplete?q=" + term + "&page=" + page).then(function (response) {
...
var PlansView = /** @class */ (function () {
    function PlansView() {
        ...
        this.rcofInput = d('id_remove_card_on_file');
        this.ccFieldset = d('_id-cardFieldset');
        this.removeCardFieldset = d('_id-removeCardFieldset');
    ...
    PlansView.prototype.updateTotalCost = function () {
        ...
        var timePeriod = plan.annual ? 'year' : 'month';
        var costFormatted = "$" + cost + " / " + timePeriod;
    ...
    PlansView.prototype.updateMaxUsers = function () {
        ...
        var minUsers = parseInt(this.maxUsersElem.min);
    ...
    PlansView.prototype.setupStripe = function () {
        ...
        if (exists('card-element')) {
            ...
            form.addEventListener('submit', function (event) {
                ...
                var ccEmpty = (document.querySelector('#card-element').classList.contains("StripeElement--empty"));
